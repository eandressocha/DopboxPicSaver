...
public class PicDetailActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            PicDetailFragment fragment = PicDetailFragment.getInstance(new DbxPath(path));
    ...
    private static class Api11Helper {
       @TargetApi(11)
       public static void setDisplayHomeAsUpEnabled(PicDetailActivity activity, boolean value) {
